...
public class andPick extends andTool {

	public andPick(int i, smelttoolmaterials smelttoolmaterials) {
	...
	static {
		 ...
		 * 5).setItemName("shovelIron"); pickaxeSteel = (new andPick(1,
		 * smelttoolmaterials.IRON)).setIconCoord(2,
		 ...
		 * smelttoolmaterials.WOOD)).setIconCoord(0,
		 * 5).setItemName("shovelWood"); pickaxeWood = (new andPick(14,
		 * smelttoolmaterials.WOOD)).setIconCoord(0,
		 ...
		 * 5).setItemName("shovelStone"); pickaxeStone = (new andPick(18,
		 ...
		 * 5).setItemName("shovelDiamond"); pickaxeDiamond = (new andPick(22,
		 ...
		 * 5).setItemName("shovelGold"); pickaxeGold = (new andPick(29,
		 * smelttoolmaterials.GOLD)).setIconCoord(4,
