...
public class steelPick extends steelTool {

	public steelPick(int i, smelttoolmaterials smelttoolmaterials) {
	...
	static {
		 ...
		 * 5).setItemName("shovelIron"); pickaxeSteel = (new agPick(1,
		 * smelttoolmaterials.IRON)).setIconCoord(2,
		 ...
		 * smelttoolmaterials.WOOD)).setIconCoord(0,
		 * 5).setItemName("shovelWood"); pickaxeWood = (new agPick(14,
		 * smelttoolmaterials.WOOD)).setIconCoord(0,
		 ...
		 * 5).setItemName("shovelStone"); pickaxeStone = (new agPick(18,
		 ...
		 * 5).setItemName("shovelDiamond"); pickaxeDiamond = (new agPick(22,
		 ...
		 * 5).setItemName("shovelGold"); pickaxeGold = (new agPick(29,
		 * smelttoolmaterials.GOLD)).setIconCoord(4,
