...
public class giPick extends giTool {

	public giPick(int i, smelttoolmaterials smelttoolmaterials) {
	...
	static {
		 ...
		 * 5).setItemName("shovelIron"); pickaxeSteel = (new giPick(1,
		 * smelttoolmaterials.IRON)).setIconCoord(2,
		 ...
		 * smelttoolmaterials.WOOD)).setIconCoord(0,
		 * 5).setItemName("shovelWood"); pickaxeWood = (new giPick(14,
		 * smelttoolmaterials.WOOD)).setIconCoord(0,
		 ...
		 * 5).setItemName("shovelStone"); pickaxeStone = (new giPick(18,
		 ...
		 * 5).setItemName("shovelDiamond"); pickaxeDiamond = (new giPick(22,
		 ...
		 * 5).setItemName("shovelGold"); pickaxeGold = (new giPick(29,
		 * smelttoolmaterials.GOLD)).setIconCoord(4,
